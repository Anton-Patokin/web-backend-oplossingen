...
<html>
    ...
    <body class="web-backend-opdracht">
      ...
      <?php
         echo "oplossing deel 1</br>";
         $fruit = 'kokosnoot';
         $fruit_legth = strlen($fruit);
         echo "length van het woord 'kokosnot' is:".$fruit_legth." karakters";
         $positie_letter= strpos($fruit,"o");
         echo "</br> posittie van leter o in word ".$fruit." bevind zieg op index:".$positie_letter ;
         ?>
         ...
         <?php 
         echo "oplossing deel 2";
$fruit = 'ananas';
         $positie_letter= strpos($fruit, "a");
         echo "</br> posittie van leter a in word ".$fruit." bevind zieg op index:".$positie_letter ;
         echo "</br>".strtoupper($fruit);
         ?>
