...
$dag_van_de_week ="";
         if ($dag == 1){
			$dag_van_de_week = "maandag";
         } 
if ($dag == 2){
			$dag_van_de_week = "dinsdag";
         } 
if ($dag == 3){
			$dag_van_de_week = "woensdag";
         } 
if ($dag == 4){
			$dag_van_de_week = "donderdag";
         } 
if ($dag == 5){
			$dag_van_de_week = "vrijdag";
         } 
if ($dag == 6 ){
			$dag_van_de_week = "zaterdag";
         } 
if ($dag == 7 ){
			$dag_van_de_week = "zaterdag";
         }
         echo $dag_van_de_week;
         ?>
...
if ($dag == 7 ){
         ...
         echo strtoupper($dag_van_de_week)."/<br>";
         echo str_replace("A","a",strtoupper($dag_van_de_week));
         ?>
        </section>
